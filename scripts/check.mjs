...
const required = ['index.html', 'styles.css', 'script.js', 'assets/hero.png', 'assets/hero.webp', 'assets/og.png', 'assets/spotlock-camera.png', 'assets/kaulist.png', 'fonts/IBMPlexSansJP-Regular.woff2', 'fonts/IBMPlexSansJP-Medium.woff2', 'fonts/IBMPlexSansJP-SemiBold.woff2', 'fonts/OFL.txt', 'provenance/index.html', 'robots.txt', 'sitemap.xml'];
